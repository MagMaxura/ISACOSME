...
export const IconShoppingCart: React.FC<IconProps> = (props) => (
...
export const IconPackage: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M16.5 9.4 7.55 4.24"/><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><path d="m3.29 7 8.71 5 8.71-5"/><path d="M12 22V12"/></svg>
);
...
// FIX: Added missing IconUserPlus export to resolve import error in Ventas.tsx.
export const IconUserPlus: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><line x1="19" y1="8" x2="19" y2="14"/><line x1="16" y1="11" x2="22" y2="11"/></svg>
);

// FIX: Added missing IconUserCheck export to resolve import error in Ventas.tsx.
...
export const IconBuildingWarehouse: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M22 12v8H2V4h14v4"/><path d="M18 18h-2v-2h2v2z"/><path d="M18 12h-2v2h2v-2z"/><path d="M12 18H9v-2h3v2z"/><path d="M12 12H9v2h3v-2z"/><path d="M6 18H4v-2h2v2z"/><path d="M6 12H4v2h2v-2z"/><path d="M22 8.8c0 .2 0 .5-.1.8-1 2.9-4.8 4.2-7.9 3.2-3-.9-5-3.8-5-7s2-6.1 5-7c3 .9 6.8 2.2 7.9 5.2.1.3.1.5.1.8z"/><path d="M16.5 6.5c1 .5 2 1.5 2.5 3"/></svg>
);

export const IconUserCog: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M19 15.5v1.5" />
        <path d="M19 21v1.5" />
        <path d="M21.02 17.5l-1.3 .75" />
        <path d="M16.98 17.5l-1.3 .75" />
        <path d="M16.98 20.5l1.3 .75" />
        <path d="M21.02 20.5l1.3 .75" />
    </svg>
);
...
export const IconMenu2: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><line x1="4" y1="6" x2="20" y2="6"></line><line x1="4" y1="12" x2="20" y2="12"></line><line x1="4" y1="18" x2="20" y2="18"></line></svg>
);
...
export const IconCamera: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M14.5 4h-5L7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3l-2.5-3z"></path><circle cx="12" cy="13.5" r="3.5"></circle></svg>
);
...
export const IconClipboardPlus: React.FC<IconProps> = (props) => (
...
export const IconCashBanknote: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const IconDeviceFloppy: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M6 4h10l4 4v10a2 2 0 0 1-2 2h-12a2 2 0 0 1-2-2v-12a2 2 0 0 1 2-2" /><circle cx="12" cy="14" r="2" /><polyline points="14 4 14 8 8 8 8 4" /></svg>
);
...
export const IconSwitchHorizontal: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><polyline points="16 3 21 3 21 8"></polyline><line x1="4" y1="20" x2="21" y2="3"></line><polyline points="8 21 3 21 3 16"></polyline><line x1="15" y1="15" x2="3" y2="3"></line></svg>
);

export const IconBrandWhatsapp: React.FC<IconProps> = (props) => (
...
// FIX: Add missing IconEye icon for viewing details.
...
// FIX: Added missing IconMessage2 export to resolve import error in KnowledgeBase.tsx and sync with src/components/Icons.tsx.
export const IconMessage2: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M8 9h8" /><path d="M8 13h6" /><path d="M12 21l-3 -3h-4a2 2 0 0 1 -2 -2v-10a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v10a2 2 0 0 1 -2 2h-5l-3 3z" /></svg>
);
